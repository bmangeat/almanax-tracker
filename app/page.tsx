...
export default function Home() {
  ...
  const { favoris, estFavori, toggleFavori } = useFavorites();
      ...
      <div className="max-w-6xl mx-auto px-4 py-10 sm:py-14">
        <header className="mb-8">
          <div className="flex items-start justify-between gap-4">
            ...
            <NotificationSettings favoris={favoris} />
          </div>
        ...
        <div className="space-y-6">
          <TodayAlmanax offrandes={offrandes} estFavori={estFavori} toggleFavori={toggleFavori} />
          <FilterBar
            filtres={filtres}
            onChange={setFiltres}
          ...
          />
          <AlmanaxTable offrandes={resultats} estFavori={estFavori} toggleFavori={toggleFavori} />
        </div>
      </div>
    </main>
  );
